    ...
    <div class="container mt-5">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                // Fetch doctor data and waiting patients count from the database
                $sql = "SELECT dname, dept, dgender, doctorid FROM doctors";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><a class='btn btn-primary' href='book_appointment.php?doctorid=$doctorId'>Book Appointment</a></td>";
                        echo "</tr>";
                    }
                } else {
